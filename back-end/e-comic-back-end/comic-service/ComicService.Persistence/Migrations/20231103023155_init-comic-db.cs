...
{
    public partial class initcomicdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ComicEpisodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Episodes_ComicEpisodeId",
                        column: x => x.ComicEpisodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_ComicEpisodeId",
                table: "Images",
                column: "ComicEpisodeId");
        }
