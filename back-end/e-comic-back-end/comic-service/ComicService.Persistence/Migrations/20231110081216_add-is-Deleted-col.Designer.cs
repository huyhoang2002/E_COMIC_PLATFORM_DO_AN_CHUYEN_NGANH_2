...
namespace ComicService.Persistence.Migrations
{
    ...
    [Migration("20231110081216_add-is-Deleted-col")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComicService.Domain.Aggregates.Comics.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ComicService.Domain.Aggregates.Comics.Comic", b =>
                {
                    b.HasOne("ComicService.Domain.Aggregates.Comics.Author", "Author")
                        .WithMany("Comics")
